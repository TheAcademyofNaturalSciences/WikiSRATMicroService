...
comid_column_numbers = {
    ...
    "tpload_farman": 16,
    "tpload_tiledrain": 17,
    "tpload_streambank": 18,
    "tpload_subsurface": 19,
    "tpload_pointsource": 20,
    "tpload_septics": 21,
    "tnload_hp": 22,
    "tnload_crop": 23,
    "tnload_wooded": 24,
    ...
    "tnload_farman": 31,
    "tnload_tiledrain": 32,
    "tnload_streambank": 33,
    "tnload_subsurface": 34,
    "tnload_pointsource": 35,
    "tnload_septics": 36,
    "tssload_hp": 37,
    "tssload_crop": 38,
    "tssload_wooded": 39,
...
comid_returned_column_numbers = {
    ...
    16: "tpload_farman",
    17: "tpload_tiledrain",
    18: "tpload_streambank",
    19: "tpload_subsurface",
    20: "tpload_pointsource",
    21: "tpload_septics",
    22: "tnload_hp",
    23: "tnload_crop",
    24: "tnload_wooded",
    ...
    31: "tnload_farman",
    32: "tnload_tiledrain",
    33: "tnload_streambank",
    34: "tnload_subsurface",
    35: "tnload_pointsource",
    36: "tnload_septics",
    37: "tssload_hp",
    38: "tssload_crop",
    39: "tssload_wooded",
...
comid_returned_column_numbers_all = {
    0: "comid",
    1: "tploadrate_total",
    2: "tploadrate_conc",
    3: "tnloadrate_total",
    ...
    77: "tpconc_tiledrain",
    78: "tnconc_tiledrain",
    79: "tssconc_tiledrain",
    80: "tpconc_streambank",
    81: "tnconc_streambank",
    82: "tssconc_streambank",
    83: "tpconc_subsurface",
    84: "tnconc_subsurface",
    85: "tpconc_septics",
    86: "tnconc_septics",
    87: "tpconc_ptsource",
    88: "tnconc_ptsource",
